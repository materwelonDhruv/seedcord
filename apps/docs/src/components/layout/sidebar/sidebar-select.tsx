            ...
            <DropdownMenu.Root open={open} onOpenChange={setOpen} modal={false}>
                ...
                <DropdownMenu.Portal>
                    <DropdownMenu.Content
                        align="start"
                        sideOffset={8}
                        className="z-[70] w-[var(--radix-dropdown-menu-trigger-width)] min-w-[220px] overflow-hidden rounded-xl border border-border/80 bg-[color-mix(in_srgb,var(--bg)_96%,#070917_4%)] p-1 shadow-[0_18px_36px_-16px_color-mix(in_srgb,var(--text)_32%,transparent)] transition-colors duration-200"
                    >
