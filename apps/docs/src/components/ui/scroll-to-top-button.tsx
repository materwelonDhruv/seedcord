...
export function ScrollToTopButton({ className }: ScrollToTopButtonProps): ReactElement {
    ...
    return (
        <Button
            ...
            className={cn(
                'h-12 w-12 rounded-full border border-border bg-[color-mix(in_srgb,var(--surface)_94%,#0f172a_6%)] text-[var(--text)] shadow-soft transition-all duration-300 hover:-translate-y-1 hover:border-[color-mix(in_srgb,var(--accent-a)_38%,var(--border))] hover:bg-[color-mix(in_srgb,var(--surface)_88%,#6366f144_12%)]',
                visible
