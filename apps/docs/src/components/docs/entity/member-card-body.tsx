...
import type { EntityMemberSummary, MemberSignatureDetail } from './member-types';
...
type SignatureSelection = [string, (id: string) => void];

function useActiveSignature(member: EntityMemberSummary): SignatureSelection {
