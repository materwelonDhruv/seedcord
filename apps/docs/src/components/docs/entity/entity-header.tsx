            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-sm leading-relaxed text-subtle">
                        Rich TypeDoc summaries are on the roadmap. Until then, review the exported signature below and
                        use the command palette to deep-dive into related members and packages.
                    </p>
                </div>
            </div>
